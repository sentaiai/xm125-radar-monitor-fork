...
fn build_presence_fifo_json(result: &PresenceMeasurement) -> String {
    ...
    format!(
        concat!(
            "{{\"confidence\":\"{confidence}\",\"detection_mode\":\"presence\",",
            "\"intra_score\":{intra_score:.3},\"inter_score\":{inter_score:.3},",
            "\"presence_detected\":{presence_detected},\"presence_distance_m\":{presence_distance_m:.3},",
            "\"sensor_type\":\"XM125\",\"signal_quality\":\"{signal_quality}\",",
            "\"timestamp\":\"{timestamp}\",\"presence_sticky\":{presence_sticky},",
            "\"R_start_m\":{start_m:.3},\"R_end_m\":{end_m:.3},",
            "\"distance_zone\":\"{distance_zone}\",\"intra_threshold\":{intra_threshold:.3},",
            "\"inter_threshold\":{inter_threshold:.3},\"actual_frame_rate_hz\":{actual_frame_rate_hz:.3},",
            "\"detector_error\":{detector_error},\"internal_temperature_c\":{internal_temperature_c},",
